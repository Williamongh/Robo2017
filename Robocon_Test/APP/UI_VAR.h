...
typedef enum
{
    ...
    VAR5,    
    VAR6,    
    VAR_16BIT  = VAR6,          //16位变量的结束编号

    /* 32位变量 */


    VAR_32BIT  = VAR_16BIT,          //32位变量的结束编号
...
extern void     var_ok(void);                           //确认当前选择的
extern void     val_cancel(void);                       //取消当前选择的值  OK


extern uint8    car_ctrl_get(void);                     //获取小车控制命令
