...
ui_var_info_t  num_info[VAR_MAX] =
{
    ...
    //务必注意最小值不要大于最大值
    {0, 0, 0, 200, {10,51}},      //变量 car_ctrl，
    {0, 0, 0, 200, {10, 17}},                //变量 SpeedStrt
    {0, 0, 0, 200, {10, 84}},               //变量 SpeedCur
    {0, 0, 0, 9, {84, 17}},               //变量 ServoD千位
    {0, 0, 0, 9, {93, 17}},               //变量 ServoD百位
    {0, 0, 0, 99, {102, 17}},             //变量 ServoD十位
    {0, 0, 0, 999, {84, 51}}              //变量 ServP
};
